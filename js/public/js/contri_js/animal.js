    ...
    $.get("/contri_animalTaxonList", function (response) {
        ...
        if (response.success == false) {
            ...
            data.forEach((element, index) => {
                ...
                row += "<td><a data-toggle='modal' href='#viewModal'><button title='View Details' onclick = 'viewAnimalTaxon(" + element.animalTaxoID + ")' type='button' rel='tooltip' class='btn btn-round btn-primary btn-icon btn-sm'><i class='now-ui-icons travel_info'></i></button></a></td>";
    ...
    $.get("/contri_animalList",(response)=>{
        ...
        if (response.success == false) {
            ...
            data.forEach((element, index) => {
                ...
                row += "<td><a data-toggle='modal' href='#viewModal'><button title='View Details' onclick = 'viewAnimal(" + element.animalID + ")' type='button' rel='tooltip' class='btn btn-round btn-primary btn-icon btn-sm'><i class='now-ui-icons travel_info'></i></button></a></td>";
                if (element.status === "approved") {
